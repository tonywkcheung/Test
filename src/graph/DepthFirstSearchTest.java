...
public class DepthFirstSearchTest {
	...
	public void doesTonyLinkToJeremy() {
		dfs.search(nodes.get(0));
		LinkedList<Vertex> path = dfs.getPath(nodes.get(3));
	...
	public void doesNatLinkJames() {
		dfs.search(nodes.get(4));
		LinkedList<Vertex> path = dfs.getPath(nodes.get(1));
	...
	public void doesCarolLinkToJimmy() {
		dfs.search(nodes.get(6));
		LinkedList<Vertex> path = dfs.getPath(nodes.get(2));
	...
	public void doesJimmyLinkToCarol() {
		dfs.search(nodes.get(2));
		LinkedList<Vertex> path = dfs.getPath(nodes.get(6));
